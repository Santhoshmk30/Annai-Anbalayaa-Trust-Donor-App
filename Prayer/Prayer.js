...
const Prayer = () => {
  ...
  const handleSubmit = async () => {
    ...
    const apiUrl = `https://annaianbalayaa.org/api/store_prayers/${userId}`;
  ...
  const fetchActivityData = async () => {
    ...
    const apiUrl = `https://annaianbalayaa.org/api/show_prayers/${userId}`;
  ...
  const renderActivityItem = ({ item, index }) => (
    <View style={styles.tableRow} key={index}>
      ...
      <Text style={styles.tableCell}>{item.reply_message}</Text>
      {item.image && (
          <Video
          source={{ uri: `https://annaianbalayaa.org/uploads/prayer${item.reply_video}` }}
          style={styles.video}
          resizeMode="cover"
    ...
    <View style={styles.mainContainer}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.tableHeader}>
          ...
          <Text style={styles.tableHeaderCell}>Video</Text>
        </View>
